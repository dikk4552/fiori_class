sap.ui.define(
    ...
    function(Controller,ProductFormatter,Filter,FilterOperator,Sorter,Fragment) {
      ...
      return Controller.extend("project4.controller.PrListMTable", {
        ...
        onSearch : function(){
            var category=this.byId("category").getValue();
                ...
                var oTable=this.byId("ProductMTable").getBinding("items");
        ...
        onhandleConfirm : function(oEvent){
            ...
            var oBinding=this.byId("ProductMTable").getBinding("items");
